...
def normal(select):
    ...
    if select == 'Home':
        ...
        if show and len(pd.read_csv(r'C:\Users\User\Desktop\Workflow Assignment\front_end\values\CIK'+cik_act+'_VALUES.csv'))!=0:
            st.dataframe(companies_bio[companies_bio['CIK'] == cik_act])
            df = pd.read_csv(r'C:\Users\User\Desktop\Workflow Assignment\front_end\values\CIK'+cik_act+'_VALUES.csv')
